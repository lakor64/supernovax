/*** Autogenerated by WIDL 9.11 from include/d3d10effect.idl 
 This file can be subject to changes because MIDL does not generate a compilable IDL for this
 (aand MSSDK DX also didn't IDL this file)
***/
