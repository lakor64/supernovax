...
function(generate_import_lib _libname _dllname _spec_file __version_arg)
    ...
    get_native_tool_path(spec2def)

    # Generate the def, asm stub and alias files
    add_custom_command(
        OUTPUT ${_asm_stubs_file} ${_def_file} ${_asm_impalias_file}
        COMMAND ${NATIVE_TOOL_EXE} --ms ${__version_arg} -a=${SPEC2DEF_ARCH} --implib -n=${_dllname} -d=${_def_file} -l=${_asm_stubs_file} -i=${_asm_impalias_file} ${CMAKE_CURRENT_SOURCE_DIR}/${_spec_file}
...
function(spec2def _dllname _spec_file)
    ...
    add_custom_command(
        ...
        COMMAND ${NATIVE_TOOL_EXE} --ms -a=${SPEC2DEF_ARCH} -n=${_dllname} -d=${CMAKE_CURRENT_BINARY_DIR}/${_file}.def -s=${CMAKE_CURRENT_BINARY_DIR}/${_file}_stubs.c ${__with_relay_arg} ${__version_arg} ${CMAKE_CURRENT_SOURCE_DIR}/${_spec_file}
        DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${_spec_file} spec2def)
