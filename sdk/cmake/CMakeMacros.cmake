...
function(set_module_type MODULE TYPE)
    ...
    elseif((${TYPE} STREQUAL win32dll) OR (${TYPE} STREQUAL win32ocx)
        ...
        #set_entrypoint(${MODULE} DllMainCRTStartup 12) # breaks MSVC idk why
...
function(utf16le_convert _in _out) ## pff specific code
    get_native_tool_path(utf16le)

    add_custom_command(OUTPUT "${_out}"
                       COMMAND ${NATIVE_TOOL_EXE} "${_in}" "${_out}" ${ARGN}
                       DEPENDS utf16le "${_in}")
